              ...
              <hr />
                {
                  ...
                  || this.state.currentRemark == REMARKS.E_PROFILE && <RemarksEdgeProfile setCurrentRemark={this.setCurrentRemark} item={this.props.item}  wo={this.props.wo} material={this.props.material}  saveItems={this.props.saveItems} />
